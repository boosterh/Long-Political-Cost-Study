...
tab_model(NSUP, SUP, file="ENGAGE_Table 3.doc")
tab_model(INTEREST, EFF, file="INT_Table 4.doc")
...
INTENTLAG <- multiplot(VOTE, PROTEST, coefficients=c("STRlag", "anglag", "reglag", "EMPlag"), xlab="Estimate", ylab="Political Emotions", outerCI = 0, lwdInner=1, pointSize = 3, zeroColor="black", newNames=c(STRlag = "Stress Lag", anglag = "Anger Lag", reglag = "Regret Lag", EMPlag = "Empowerment Lag"), title = "Lagged Effects of Political Emotions on Intent", scales="fixed") 

INTENTLAG <- INTENTLAG + xlim(-.15, .30) 

INTERESTLAG <- multiplot(INTEREST, EFF, coefficients=c("STRlag", "anglag", "reglag", "EMPlag"), xlab="Estimate", ylab="Political Emotions", outerCI = 0, lwdInner=1, pointSize = 3, zeroColor="black", newNames=c(STRlag = "Stress Lag", anglag = "Anger Lag", reglag = "Regret Lag", EMPlag = "Empowerment Lag"), title = "Lagged Effects of Political Emotions on Interest and Efficacy") 

INTERESTLAG <-  INTERESTLAG + xlim(-.15, .30) 

PARTLAG <- multiplot(NSUP, SUP, coefficients=c("STRlag", "anglag", "reglag", "EMPlag"), xlab="Estimate", ylab="Political Emotions", outerCI = 0, lwdInner=1, pointSize = 3, zeroColor="black", newNames=c(STRlag = "Stress Lag", anglag = "Anger Lag", reglag = "Regret Lag", EMPlag = "Empowerment Lag"), title = "Lagged Effects of Political Emotions on Participation") 

PARTLAG <-  PARTLAG + xlim(-.15, .30) 

INTENT <- multiplot(VOTE, PROTEST, coefficients=c("STR", "ang", "reg", "EMP"), xlab="Estimate", ylab="Political Emotions", outerCI = 0, lwdInner=1, pointSize = 3, zeroColor="black", newNames=c(STR = "Stress", ang = "Anger", reg = "Regret", EMP = "Empowerment"), title = "Same-Moment Effects of Political Emotions on Intent") 

INTENT <- INTENT + xlim(-.15, .30) 

INTEREST <- multiplot(INTEREST, EFF, coefficients=c("STR", "ang", "reg", "EMP"), xlab="Estimate", ylab="Political Emotions", outerCI = 0, lwdInner=1, pointSize = 3, zeroColor="black", newNames=c(STR = "Stress", ang = "Anger", reg = "Regret", EMP = "Empowerment"), title = "Same-Moment Effects of Political Emotions on Interest and Efficacy") 

INTEREST <- INTEREST + xlim(-.15, .30) 

PART <- multiplot(NSUP, SUP, coefficients=c("STR", "ang", "reg", "EMP"), xlab="Estimate", ylab="Political Emotions", outerCI = 0, lwdInner=1, pointSize = 3, zeroColor="black", newNames=c(STR = "Stress", ang = "Anger", reg = "Regret", EMP = "Empowerment"), title = "Same-Moment Effects of Political Emotions on Participation") 

PART <- PART + xlim(-.15, .30) 
